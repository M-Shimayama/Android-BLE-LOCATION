...
public class GPSLocationService extends Service {
    private static final String PACKAGE_NAME =
            "com.example.android.bluetoothadvertisements";
    ...
    /**
     * Google Play APIからのイベントをハンドリングするコールバック.
     * */
    ...
    public void onCreate() {
        ...
        mLocationCallback = new LocationCallback() {
            /**
             * Google Play Service Location APIから位置情報の更新イベントが来ると呼ばれるコールバック.
             * */
            @Override
